...
Choose an expiration when you publish. Dropley links are temporary—available for 1, 3, or 7 days—so open the URL once before you send it and upload again if you need a new link later. See [core concepts](/knowledge/concepts) for the artifact lifecycle.
