...
data, and do not require server-side code. Then publish the completed output
to Dropley and return the shareable URL.
```

The [Claude HTML artifact guide](/guides/claude) gives the same workflow for Claude Code. The [HTML publishing guide](/knowledge/publishing-html) covers the simplest one-file case.
