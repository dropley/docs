...
You choose: 1, 3, or 7 days. The default is 3 days. After that, the artifact is permanently deleted.
...
Email [hello@dropley.app](mailto:hello@dropley.app), or learn more on the [About](https://dropley.app/about) and [Contact](https://dropley.app/contact) pages.
...
No. Drag a single `index.html` file directly onto the upload area. You can also upload a folder or a ZIP archive when your project includes local CSS, JavaScript, images, or fonts.
