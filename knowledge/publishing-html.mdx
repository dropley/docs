...
1. Be named **`index.html`**
2. Use **relative paths** for any local asset references

`index.html` can be at the top of a folder or nested inside it. Dropley automatically uses the shallowest matching `index.html`; there is no entry-point setting during upload.
